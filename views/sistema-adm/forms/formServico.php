              ...
              <div class="box-body">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="nome" class="form-control" id="txtTitulo" placeholder="Digite o título" 
                      value="<?php echo (!empty($info_servico['id'])) ? $info_servico['nome'] : ''; ?>" required>
                  </div>
                </div>

                <div class="col-md-4">
                  <div class="form-group">
                      <label for="imagem_capa">Imagem do Serviço</label>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                      ...
                      <input type ="text" name="alt_imagem_capa" class="form-control" id="alt_imagem_capa" 
                        value="<?php echo (!empty($info_servico['id'])) ? $info_servico['alt_imagem_capa'] : ''; ?>">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                      ...
                      <textarea name="descricao" class="form-control" id="descricao">
                        <?php echo (!empty($info_servico['id'])) ? $info_servico['descricao'] : ''; ?>
                      </textarea>
                  </div>
                </div>
                ...
                <div class="col-md-7">
                  <div class="form-group">
                      ...
                      <input type="text" name="slug" id="slug" class="form-control" value="<?php echo (!empty($info_servico['id'])) ? $info_servico['slug'] : ''; ?>">
                  </div>
                </div>
